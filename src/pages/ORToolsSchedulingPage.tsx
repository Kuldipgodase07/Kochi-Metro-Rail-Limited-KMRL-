import { ORToolsSchedulingDashboard } from '@/components/ORToolsSchedulingDashboard'
import { Link } from 'react-router-dom'
import { ArrowLeft } from 'lucide-react'
import { Button } from '@/components/ui/button'
import KMRLLogo from '@/components/KMRLLogo'

export default function ORToolsSchedulingPage() {
  return (
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center space-x-3">
              <KMRLLogo height={28} />
              <div>
                <h1 className="text-xl font-bold text-gray-900 dark:text-white">Google OR-Tools Scheduling</h1>
                <p className="text-sm text-gray-600 dark:text-gray-300">Advanced constraint programming optimization</p>
              </div>
            </div>
            <Link to="/dashboard">
