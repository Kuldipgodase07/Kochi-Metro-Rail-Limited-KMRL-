        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center space-x-3">
              <KMRLLogo height={28} />
              <div>
                <h1 className="text-xl font-bold text-gray-900 dark:text-white">Manual Scheduling</h1>
                <p className="text-sm text-gray-600 dark:text-gray-300">Traditional scheduling interface</p>
              </div>
            </div>
            <Link to="/dashboard">
